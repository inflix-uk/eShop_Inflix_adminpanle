...
export default function BlogsTab({ selectedTab, setSelectedTab }) {
  ...
  const tabs = [
    {
      ...
      current: selectedTab === "all-blogs",
    },
    {
      name: "Draft Blogs",
      link: "/admin/draft-blogs",
      current: selectedTab === "draft-blogs",
    },
    {
      name: "Add New Blogs",
      link: "/admin/new-blog",
      current: selectedTab === "new-blog",
    },
    {
      name: "Categories",
      link: "/admin/blog-categories",
      current: selectedTab === "blog-categories",
    },
  ];
