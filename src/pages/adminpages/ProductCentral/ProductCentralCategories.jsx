...
import ProductCategories from "../../../components/ProductCentralComponents/ProductCategories";
import { Helmet } from "react-helmet-async";

export default function ProductCentralCategories() {
  ...
  return (
    <>
      ...
      />
      <Helmet>
        <title>Categories - Product Central</title>
      </Helmet>
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium text-emerald-600 md:ml-2">Categories</span>
                  </div>
                </li>
              </ol>
            </nav>
