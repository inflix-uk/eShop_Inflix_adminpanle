...
const RefundModal = ({ isOpen, onClose, onSubmit, orderTotal }) => {
      ...
      >
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-primary">
            <h3 className="text-lg font-semibold text-gray-900">Order Refund</h3>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit}>
            <div className="p-6 space-y-6">
              ...
              {/* Refund Reason */}
              <div>
                <label htmlFor="refundReason" className="block text-sm font-medium text-gray-900 mb-2">
                ...
                <textarea
                  ...
                  className={`block w-full rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ${
                    errors.refundReason ? 'ring-red-500' : 'ring-gray-300'
                  } placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6`}
